...
{
    public class RequestHandler8<T, TR, TU, TI, TJ, TK, TL, TM> : RequestHandler
    {
        ...
        internal ParameterResolver<TM> ResolverParam8 { get; }
        
        private ParamExecutor8? _executor;

        public delegate ICompletes<Response> Handler8(T param1, TR param2, TU param3, TI param4, TJ param5, TK param6, TL param7, TM param8);
        public delegate ICompletes<IObjectResponse> ObjectHandler8(T param1, TR param2, TU param3, TI param4, TJ param5, TK param6, TL param7, TM param8);
        internal delegate ICompletes<Response> ParamExecutor8(
            Request request,
            T param1,
            TR param2,
            TU param3,
        ...
        internal RequestHandler8(
            ...
            IErrorHandler errorHandler,
            MediaTypeMapper mediaTypeMapper)
            : base(method, path, new List<IParameterResolver> { resolverParam1, resolverParam2, resolverParam3, resolverParam4, resolverParam5, resolverParam6, resolverParam7, resolverParam8 }, errorHandler, mediaTypeMapper)
        {
        ...
        internal ICompletes<Response> Execute(Request request, T param1, TR param2, TU param3, TI param4, TJ param5, TK param6, TL param7, TM param8, ILogger logger)
        {
            Func<ICompletes<Response>> exec = ()
                => _executor?.Invoke(request, param1, param2, param3, param4, param5, param6, param7, param8, MediaTypeMapper, ErrorHandler, logger)!;
        ...
        public RequestHandler8<T, TR, TU, TI, TJ, TK, TL, TM> Handle(ObjectHandler8 handler)
        {
            _executor = (request, param1, param2, param3, param4, param5, param6, param7, param8, mediaTypeMapper1, errorHandler1, logger)
                => RequestObjectExecutor.ExecuteRequest(
                    request,
                    mediaTypeMapper1,
                    () => handler.Invoke(param1, param2, param3, param4, param5, param6, param7, param8),
                    errorHandler1,
                    logger);
            return this;
        }

        public RequestHandler8<T, TR, TU, TI, TJ, TK, TL, TM> OnError(IErrorHandler errorHandler)
        {
            ...
            ILogger logger)
        {
            ...
            var param8 = ResolverParam8.Apply(request, mappedParameters);
            return Execute(request, param1, param2, param3, param4, param5, param6, param7, param8, logger);
        }
    }
}
